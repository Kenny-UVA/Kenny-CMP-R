...
ggplot(                   
   ...
   geom_jitter() + scale_size_continuous(      
    trans = "exp",           
    guide = "none"            
  )
...
### Summer Renaissance - Tempogram {data-commentary-width="400"}

```{r ggplot6}

summer_renaissance <- get_tidy_audio_analysis("3HyR1j49TY5ACP2lseF1jx")
summer_renaissance |>
